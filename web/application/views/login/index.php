...
<body style="
background: linear-gradient(rgba(0, 0, 0, 0.7),rgba(0, 0, 0, 0.7)),url(<?= base_url('assets/img/d205800c49d3891f0b0c8a89d1e0de96.jpg'); ?>); 
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <h3 class="text-light mt-2">LOGIN</h3>
                        </div>
